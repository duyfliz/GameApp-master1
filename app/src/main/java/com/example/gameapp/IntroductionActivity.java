...
//        if (!PrefManager.getInstance(IntroductionActivity.this).isFirstTimeLaunch()) {
//            launchHomeScreen();
//        }
         ...
         */
        mLayouts = new int[]{R.layout.welcome1, R.layout.welcome2, R.layout.welcome3, R.layout.welcome4};
        addBottomDots(0);
    ...
    private void launchHomeScreen() {
        Intent intent = new Intent(IntroductionActivity.this, AuthenActivity.class);
